      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="POST" action="{{route('save_rent')}}">
              @csrf
              <div class="box-body">
  <div class="col-lg-6">
                ...
                <div class="form-group">
                  ...
                  <input type="Title" class="form-control" id="exampleInputPassword1" placeholder="Rent_Received" name="rent_recieved">
                </div>
                                <div class="form-group">
                  <label for="exampleInputPassword1">Rent_Renewing</label>
                  <input type="Title" class="form-control" id="exampleInputPassword1" placeholder="Rent_Renewing" name="rent_renewing">
                </div>
