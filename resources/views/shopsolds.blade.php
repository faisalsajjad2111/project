      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="POST" action="{{route('save_solds')}}">
                            @csrf
              <div class="box-body">
  <div class="col-lg-6">
                ...
                <div class="form-group">
                  ...
                  <input type="Title" class="form-control" id="exampleInputPassword1" placeholder="application_date"name="application_date">
                </div>
                                <div class="form-group">
              ...
              <div class="col-lg-6">
                ...
                <div class="form-group">
                  ...
                  <input type="Title" class="form-control" id="exampleInputPassword1" placeholder="other Chargers"name="other_Chargers">
                </div>
                <div class="form-group">
