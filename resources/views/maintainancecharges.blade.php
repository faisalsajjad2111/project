      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
 <form role="form" method="POST" action="{{route('maintain_charges')}}">
              @csrf
                            <div class="box-body">
  <div class="col-lg-6">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <input type="Title" class="form-control" id="exampleInputPassword1" placeholder="MaintCharges" name="MaintCharges">
                </div>
              </div>
              ...
              <div class="col-lg-6">
                  ...
                  <input type="Title" class="form-control" id="exampleInputPassword1" placeholder="Total" name="Total">
                </div>
              
                  <div class="form-group">
                  <label for="exampleInputPassword1">Reciieved</label>
                  <input type="Title" class="form-control" id="exampleInputPassword1" placeholder="Reciieved" name="Reciieved">
                </div>
                 <div class="form-group">
